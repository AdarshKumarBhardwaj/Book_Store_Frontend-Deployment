      ...
      >
        <div className="navbar">
          <div className="navbar-start">
            ...
            <a className=" text-2xl font-bold cursor-pointer lg:flex ">
              <span className="px-4">
                <IoBookSharp size={30} />
              </span>
              <span>bookStore</span>
          ...
          <div className="navbar-end space-x-3">
            ...
            {authUser ? (
              ...
              <div>
                <a
                  className="bg-black text-white  px-3 px-2 p-2 rounded-md hover:bg-slate-800 duration-300 cursor-pointer"
                  onClick={() =>
